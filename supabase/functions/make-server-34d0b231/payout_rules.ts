 ...
 * ever have one signature, so it needs one.
 *
 * Server copy of src/domain/payouts.ts — the app shows these rules, this file
...
export type PayoutStatus =
  'scheduled' | 'processing' | 'awaiting_confirmation' | 'completed' | 'disputed' | 'cancelled';
