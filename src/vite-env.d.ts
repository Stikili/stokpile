...
// The codebase uses versioned import paths (e.g., 'sonner@2.0.3')
// which Vite resolves at runtime. These declarations provide
// TypeScript type information by re-exporting from the actual packages.
// ============================================================
...
declare module '@radix-ui/react-toast@1.2.6' {
...
declare module 'tailwind-merge@3.0.2' {
